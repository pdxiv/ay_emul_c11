...
typedef struct sqt_file {
  ...
  int64_t global_tick_max; /* Players.pas:15889-16679, GetTimeSQT's Tm */
  int64_t loop_tick;       /* Players.pas:15889-16679, GetTimeSQT's Lp */
 ...
 * `chip` (any ay_chip, not necessarily f->ay.chip - see sqt_file.c's own
 ...
 * pairing driver (player_step_registers) uses; sqt_file_make_buffer
